...
export function SortableKanbanCard({ task, onUpdateTask, onDeleteTask, onOpenTaskDetails }: SortableKanbanCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute bottom-2 right-2 p-2 rounded-md cursor-grab active:cursor-grabbing opacity-0 group-hover:opacity-100 transition-opacity duration-200 hover:bg-muted/80 bg-background/90 border border-border/50 shadow-sm z-10"
